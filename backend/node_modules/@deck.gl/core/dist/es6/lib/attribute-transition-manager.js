...
export default class AttributeTransitionManager {
  ...
  _getNextTransitionStates(transition, settings) {
    ...
    const fromLength = fromState instanceof Buffer && fromState.getElementCount() || toLength; // Alternate between two buffers when new transitions start.
  ...
  _triggerTransition(transition, settings) {
    ...
    const transitionSettings = Object.assign({}, DEFAULT_TRANSITION_SETTINGS, settings); // Attribute descriptor to transition from
