...
export function padBuffer({
  ...
  const hasBufferLayout = fromBufferLayout && toBufferLayout; // check if buffer needs to be padded
  ...
  const getMissingData = constant ? (i, chunk) => getData(value, chunk) : (i, chunk) => getData(toData.subarray(i, i + size), chunk);
  padArray({
    source: fromData,
    target: data,
