...
export default class LayerAttribute extends Attribute {
  constructor(gl, opts = {}) {
    ...
    Object.seal(this.userData); // Check all fields and generate helpful error messages
  ...
  getUpdateTriggers() {
    const accessor = this.userData.accessor; // Backards compatibility: allow attribute name to be used as update trigger key
  ...
  getTransitionSetting(opts) {
    ...
    let settings = Array.isArray(accessor) ? opts[accessor.find(a => opts[a])] : opts[accessor]; // Shorthand: use duration instead of parameter object
  ...
  _validateAttributeUpdaters() {
    const state = this.userData; // Check that either 'accessor' or 'update' is a valid function
