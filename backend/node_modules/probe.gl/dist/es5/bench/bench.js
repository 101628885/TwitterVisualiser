...
exports.default = exports.LOG_ENTRY = void 0;
...
var _localStorage = _interopRequireDefault(require("../lib/utils/local-storage"));
...
var Bench = function () {
  function Bench() {
    ...
    (0, _classCallCheck2.default)(this, Bench);
  ...
  (0, _createClass2.default)(Bench, [{
    ...
    value: function group(id) {
      (0, _assert.default)(!this.tests[id], 'tests need unique id strings');
      this.tests[id] = {
        id: id,
        group: true,
        opts: this.opts
    ...
    value: function add(priority, id, func1, func2) {
      ...
      (0, _assert.default)(id);
      (0, _assert.default)(typeof func1 === 'function');
      var initFunc = null;
      var testFunc = func1;
...
function logResultsAsMarkdownTable(_ref6) {
  ...
  switch (entry) {
    case LOG_ENTRY.GROUP:
      console.log('');
      console.log("| ".concat((0, _formatters.rightPad)(id, COL1), " | iterations/s |"));
      console.log("| ".concat((0, _formatters.rightPad)('---', COL1), " | ---          |"));
      break;

    case LOG_ENTRY.TEST:
      console.log("| ".concat((0, _formatters.rightPad)(id, COL1), " | ").concat((0, _formatters.rightPad)(itersPerSecond, COL2), " |"));
      break;
