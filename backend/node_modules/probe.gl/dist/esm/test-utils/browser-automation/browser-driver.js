  ...
  _createClass(BrowserDriver, [{
    ...
    value: function startServer() {
      ...
      return new Promise(function (resolve, reject) {
        ...
        _this5.child = _this5.execFile(newConfig.process, _toConsumableArray(newConfig.parameters).concat(['--port', "".concat(newConfig.port)]), newConfig.options, function (error) {
          if (error) {
...
export { BrowserDriver as default };
